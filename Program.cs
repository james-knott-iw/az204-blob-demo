...
static async Task ProcessAsync()
{
    ...
    string storageConnectionString = "DefaultEndpointsProtocol=https;AccountName=jibbsystorage;AccountKey=tjru60+9ApzkrTe1nChJDdhhG1PS8p5CxznlCjR2+w7tz21KAYEN8a+tdfheb7Qe3yhomwtoqlTW+ASteCSQGw==;EndpointSuffix=core.windows.net";
    ...
    //dowload the blob's contents and save it to a file
    ...
    Console.WriteLine("Deleting the local source and donloaded files...");
